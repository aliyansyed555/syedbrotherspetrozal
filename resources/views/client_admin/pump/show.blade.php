                            ...
                            <table class="table fs-6 fw-bold gs-0 gy-2 gx-2">
                                <tr>
                                    ...
                                    <td class="text-gray-800 p-1">
                                        ...
                                        <form action="{{ route('pump.updateInvestment', $pump->id) }}" method="POST" id="totalInvestmentForm" style="display: flex; align-items: center; gap: 10px;">
                                            @csrf
                                            @method('PUT')
                                            <input
                                                style="max-width: 100px; border: 1px solid #ccc; padding: 5px; border-radius: 4px;"
                                                type="number"
                                                ...
                                                step="0.01"
                                            >
                                            <button type="submit" style="padding: 5px 10px; display: inline-flex; align-items: center;" class="btn btn-secondary btn-sm" title="Click to save investment">
