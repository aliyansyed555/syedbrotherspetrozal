        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-body py-3">
                <div class="table-responsive">
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="pricing_table">
                        <thead>
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer flex-center">
                        ...
                        <button type="submit" class="btn btn-primary submit_btn" id="pricing_submit">Save</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            var KTDatatablesServerSide = function() {
                ...
                var initDatatable = function() {
                    dt = $("#pricing_table").DataTable({
                        ...
                        ajax: {
                            url: `/pump/${pumpId}/pricing/get_all`,
                        ...
                        columnDefs: [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, row) {
                                    return `<button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit_btn" data-bs-toggle="modal" data-bs-target="#pricing_modal" data-obj='${JSON.stringify(row)}'>
                                            <span class="svg-icon svg-icon-3">
