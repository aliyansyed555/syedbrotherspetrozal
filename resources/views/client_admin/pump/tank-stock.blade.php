...
@section('main-content')
        ...
        <div class="card mb-5 mb-xl-8">
            ...
            <div class="card-header border-0 pt-5">
                <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Fuel stock</span>
                </h3>
            ...
            <div class="card-body py-3">
                <div class="table-responsive">
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4" id="stock_table">
                        <thead>
    ...
    <form action="" method="POST" id="stock_form" class="validate-form">
            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer flex-center">
                        ...
                        <button type="submit" class="btn btn-primary submit_btn" id="stock_submit">Save</button>
                    </div>
                </div>
            </div>
        </div>
...
@section('javascript')
    <script>
        $(document).ready(function() {
                        ...
                        columnDefs: [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, row) {
                                    return `<button class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1 edit_btn" data-bs-toggle="modal" data-bs-target="#stock_modal" data-obj='${JSON.stringify(row)}'>
                                            <span class="svg-icon svg-icon-3">
            ...
            $('#stock_table').on('click', '.edit_btn', function (e) {
                e.preventDefault();
            ...
            handlingForms('stock', prefix);
            deleteFn('stock', prefix)
        });
