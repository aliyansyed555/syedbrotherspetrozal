            ...
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <div class="modal-content">
                    ...
                    <div class="modal-footer flex-center">
                        ...
                        <button type="submit" class="btn btn-primary submit_btn" id="customer_submit">Save</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            var KTDatatablesServerSide = function() {
                ...
                var initDatatable = function() {
                    dt = $("#customer_table").DataTable({
                        ...
                        ajax: {
                            url: `/pump/${pumpId}/customer/getAll`,
                        },
                        columns: [{
                                data: 'id'
                            },
                        ...
                        columnDefs: [{
                            ...
                            },
                            {
                                ...
                                render: function(data, type, row) {
                                    return `
                                        <a href="/pump/${pumpId}/customer/credits/${row.id}" class="btn btn-bg-light btn-active-color-primary btn-sm me-1 edit_btn" '>Credit History</a>
